...
function ItemList({items, onItemSelect}) {
  ...
  const sortedItems = [...items].sort((a, b) => {
    if (sortBy === "name") {
      // Sort by name
      const nameA = a.name || ""; // Handle undefined name property
      const nameB = b.name || ""; // Handle undefined name property
      return nameA.localeCompare(nameB);
    } else if (sortBy === "category") {
      // Sort by category
      const categoryA = a.category || ""; // Handle undefined category property
      const categoryB = b.category || ""; // Handle undefined category property
